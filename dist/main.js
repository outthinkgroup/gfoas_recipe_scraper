      ...
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); //clears any errors

              errorBlock = document.querySelector(".errors");
              errorBlock.innerHTML = "";
              form = e.target;
              recipe = form.querySelector("#recipe");
...
function temporaryMessage(el, msg, idleText) {
  var time = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 2000;
  var html = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
